...
| | |
|-|-|
| UI content{: .h3} [![Image of a dummy software user interface page with inline UI help content](images/ui-content.png)](#user-interface-content) | **User help**<br/> [![Image of a dummy user help window that is displayed in front of a software user interface page.](images/user-help.png)](#user-help)|
| **Developer help**<br/> [![Image of a dummy Python notebook](images/dev-help.png)](#developer-help) | **Administrator help**<br/> [![Image of a dummy system administrator's dashboard](images/admin-help.png)](#developer-help) |
